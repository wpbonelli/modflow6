    ...
    if (isfound) then
      ...
      do
        ...
        case ('GWFGRID')
          ...
          ! check node count
          call read_grb(this%gfr, "NCELLS", nodes)
          ...
          case ('DIS')
            ...
            type is (DisType)
              call read_grb(this%gfr, "IDOMAIN", idomain3d)
          ...
          case ('DISV')
            select type (dis => this%dis)
            type is (DisvType)
              call read_grb(this%gfr, "IDOMAIN", idomain2d)
          ...
          case ('DISU')
            select type (dis => this%dis)
            type is (DisuType)
              call read_grb(this%gfr, "IDOMAIN", idomain1d)
