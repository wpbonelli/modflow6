...
contains
  ...
  !< @brief initialize
  !<
  subroutine initialize(this, iu, iout, ncrbud, backwards)
    ! -- dummy
    ...
    if (present(backwards)) this%backwards = backwards
    ncrbud = 0
    maxaux = 0
    call this%rewind()
    !
    ...
    !
    if (this%backwards) call this%build_index()
  ...
  subroutine read_record(this, success, iout)
    ...
    !
    ! Handle indexed backwards traversal
    if (this%indexed .and. this%backwards) then
