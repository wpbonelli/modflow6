...
\begin{itemize}
	...
	\item The PRT Model did not report time step end events correctly with the DRY\_TRACKING\_METHOD options DROP and STRAND. This was only relevant for Newton formulation models.
