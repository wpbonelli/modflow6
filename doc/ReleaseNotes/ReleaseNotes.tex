...
6.8.1 & September 23, 2026 & \url{https://doi.org/10.5066/P1PGE9XW} \\
\hline
\label{tab:releases}
\end{tabular*}
\end{center}
...
\item
When the Streamflow Routing (SFR) Package STORAGE option is used with the ATS\_COURANT option (the explicit TVD kinematic-wave routing scheme), a dry gaining reach (groundwater head above the streambed top) with little or no routed inflow may fail to rewet and can remain dry with zero groundwater discharge. The standard kinematic-wave scheme (STORAGE without ATS\_COURANT) rewets these reaches correctly and should be used where dry gaining reaches are expected.
