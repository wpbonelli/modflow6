...
Constant-Head Boundary input can be specified using lists or grid arrays.  Grid array-based input for the CHD package is activated by providing READARRAYGRID within the OPTIONS block.  Instructions for specifying list-based constant-head boundaries are provided in the previous section.
