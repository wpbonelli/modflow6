...
River input can be specified using lists or grid arrays.  Grid array-based input for the RIV package is activated by providing READARRAYGRID within the OPTIONS block.  Instructions for specifying list-based river input are provided in the previous section.
