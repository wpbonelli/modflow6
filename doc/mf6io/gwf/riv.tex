...
River input can be specified using lists or arrays.  List-based input for the RIV package is the default, and is described here.  Instructions for specifying array-based RIV input are provided in the next section.
