...
\end{aligned}
\end{equation}
where the summation corresponds to the summation in equation \ref{eqn:visclinear} that accounts for the additive effects of simulated dissolved solute species (but not temperature) on viscosity.
