...
- [ ] Added a release note fragment to [doc/ReleaseNotes/items/](/MODFLOW-ORG/modflow6/doc/ReleaseNotes/items) with a plain-language description of the bug fix, change, or feature; required for changes that may affect users
